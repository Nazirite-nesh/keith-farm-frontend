...
function Animals() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      alert("Error adding animal. Tag may already exist.");
    }
  };
              ...
              {filtered.map((a) => (
                <tr key={a._id} style={styles.row}>
                  ...
                  <td>
                    <span style={{
                      ...styles.badge,
                      background: a.status === "Active" ? "#2e7d32" :
...
const styles = {
  ...
  badge: { color: "white", padding: "4px 8px", borderRadius: 12,
    fontSize: 12 },
