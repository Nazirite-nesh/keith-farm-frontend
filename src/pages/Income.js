    ...
    <div>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.totalCard}>
          <h3>Total Income</h3>
          <p style={{color: "#2e7d32", fontSize: 22}}>KES {total.toLocaleString()}</p>
        </div>

        <h3 style={styles.subtitle}>{editId ? "✏️ Edit Income" : "Add Income"}</h3>
            ...
            <tbody>
              {data.map((item) => (
                <tr key={item._id} style={styles.row}>
                  ...
                  <td style={{color: "#2e7d32"}}>KES {item.total}</td>
                  <td>
